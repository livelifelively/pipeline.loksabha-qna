...
def setup_debugger(
    host: Optional[str] = None, port: Optional[int] = None, wait_for_client: Optional[bool] = None
) -> None:
    """
    ...
    """
    if os.getenv("DEBUG_ENABLED", "").lower() not in ("true", "1", "yes"):
        return
    ...
    try:
        ...
        should_wait = (
            ...
            else os.getenv("DEBUG_WAIT", "true").lower() in ("true", "1", "yes")
        )
